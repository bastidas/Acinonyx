...
import { exploreNodeTrajectoriesToolHandler } from './exploreNodeTrajectoriesToolHandler'
...
export { exploreNodeTrajectoriesToolHandler } from './exploreNodeTrajectoriesToolHandler'
...
export function getToolHandler(mode: ToolMode): ToolHandler {
  switch (mode) {
    ...
    case 'explore_node_trajectories':
      return exploreNodeTrajectoriesToolHandler
    default:
